...
function Api(baseUrl, options) {
  ...
  this.multiPoll = function(body, callback) {
    ...
    _req('post', '/external-task/multi-poll', { json: true, body: body }, function(err, response, body) {
  ...
  this.taskFailed = function(taskId, body, callback) {
    ...
    _req('post', '/external-task/' + taskId + '/failed', { json: true, body: body }, function(err, response, body) {
